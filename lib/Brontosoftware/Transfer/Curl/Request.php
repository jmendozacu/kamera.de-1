 ...
 */
class Brontosoftware_Transfer_Curl_Request implements Brontosoftware_Transfer_Request
{
    private $_method;
    private $_uri;
    private $_options;
     ...
     * @param string $method
     * @param string $uri
     * @param Brontosoftware_DataObject $options
     * @param Brontosoftware_StandardResource_Proxy $curl
     */
    public function __construct($method, $uri, $options, $curl = null)
    {
        $this->_uri = $uri;
        $this->_method = $method;
        $this->_options = new Brontosoftware_DataObject($options->toArray());
        if (is_null($curl)) {
            $curl = new Brontosoftware_StandardResource_Proxy("curl_");
        }
        $this->_curl = $curl;
    }
     ...
     *
     * @return Brontosoftware_StandardResource_Proxy
     */
    ...
    protected function _completeRequest()
    {
        ...
        if ($code) {
            ...
            $this->_curl->close();
            throw $this->error(new Brontosoftware_Transfer_Exception($message, $code, $this));
        }
    ...
    public function respond()
    {
        ...
        return $this->complete(new Brontosoftware_Transfer_Curl_Response($content, $info));
    }
}
