...
/**
 * Brontosoftware_Serialize_Json_Standard PCL bidirectional serializer
 *
 * @author Philip Cali <philip.cali@bronto.com>
 */
class Brontosoftware_Serialize_Json_Standard implements Brontosoftware_Serialize_BiDirectional
{
     ...
     * @throws Brontosoftware_Serialize_Exception
     */
    protected function _catchAndThrowError($thingOrInput, $encoding)
    {
        ...
        if ($erroNo) {
            ...
            throw new Brontosoftware_Serialize_Exception($error, $erroNo, $thingOrInput, $encoding);
        }
    }
