 ...
 *
 * For the original:
 * @see src/Bronto/Magento/Connector/Discovery/Endpoint.php
 */

class Brontosoftware_Magento_Connector_Discovery_Endpoint
{
     ...
     * @return $this
     */
    public function withType($type, $data = array())
    {
    ...
    protected function _addItem($keyName, array $data, $implicitPosition = false)
    {
        if (!array_key_exists($keyName, $this->_information)) {
            $this->_information[$keyName] = array();
        }
        if (array_key_exists('id', $data)) {
            ...
            $data = array('sort_order' => $this->_increment($keyName), 'definition' => $data);
        }
